...
Természetesen nagyon sok forgalom generáló alkalmazást tudunk felhasznélni és a kész rendszer korábbi verziójában mást használtunk.
...
Ebben nagy segítségemre volt egy összegyűjtött alklamazás lista\citep{benchmarkToolsList} így megkeresni már nem csak össze kellett hasonlítani őket.
...
Egy-egy terhelés szimulációjához meg kell adnunk pár paramétert az alklamazás indításához. 
