...
Valamint lehetőséget biztosít, hogy több nyelven, keretrendszerben legyenek megoldva az alfeladatok. 
Ezáltal minden lépéshez a számára legelőnyösebb környezetet lehet megválasztani. 
Valamint ha egy komponenst szeretnénk teljesen elölről fejleszteni, akkor az a rendszer többi részét nem érinti.
...
Ugye sokan választották az új megközelítést, mert ígérete szerint könnyen képes a beérkező kérések okozta terheléssel arányosan skálázódni.
...
Egy konkrét példán keresztül bemutatom a HPA megoldását. 
