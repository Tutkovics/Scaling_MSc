...
Emiatt ezen osztályba tartozó podok lesznek először leállítva, ha fogytán van a csomóponton elérhető erőforrások mennyisége.
\\
\\
A fentebb leírtak miatt körültekintőnek kell maradni, hogyan soroljuk be minőség osztályok alá az egyes alkalmazás részeinket és hogyan priorizáljuk ezzel együtt őket. 
