...
A kapott eredmények láthatóak \aref{analitic-model} ábrán.

A legfelső[\aref{subfig:model-1FE-1BE}] grafikon mutatja azt az esetet, amikor egy darab backend konténer szolgálta ki az összes frontend felől érkező kérést.
...
A grafikonról[\aref{subfig:model-1FE-2BE}] leolvasva az így kapott QPS érték 66 körül alakul, de nem éri el a 70-et.
