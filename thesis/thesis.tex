...
\usepackage{multicol}           % multi column page for glossary
\usepackage{color}
...
%\lstset{ 
%  basicstyle=\small\linespread{0.1},        % the size of the fonts that are used for the code
%}
...
\include{content/abstract}    % Magyar és angol nyelvű absztrakt
...
%\bibliographystyle{plainnat} %acm
...
\include{content/abbreviations} % rövidítések, és fordítások
